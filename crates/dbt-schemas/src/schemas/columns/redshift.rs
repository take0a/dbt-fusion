...
pub struct RedshiftColumnType;

impl StaticBaseColumn for RedshiftColumnType {
    fn try_new(
        name: String,
        dtype: String,
        ...
        Ok(Value::from_object(RedshiftColumn {
            name,
            dtype,
            char_size,
            numeric_precision,
...
impl BaseColumn for RedshiftColumn {
...
impl BaseColumnProperties for RedshiftColumn {
