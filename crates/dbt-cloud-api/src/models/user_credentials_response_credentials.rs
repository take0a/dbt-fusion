...
#[serde(untagged)]
pub enum UserCredentialsResponseCredentials {
    PostgresCredentials(Box<models::PostgresCredentials>),
    SnowflakeCredentials(Box<models::SnowflakeCredentials>),
    BigqueryCredentials(Box<models::BigqueryCredentials>),
    RedshiftCredentials(Box<models::RedshiftCredentials>),
    DbtAdapterCredentials(Box<models::DbtAdapterCredentials>),
}

impl Default for UserCredentialsResponseCredentials {
    fn default() -> Self {
        Self::PostgresCredentials(Default::default())
    }
}
