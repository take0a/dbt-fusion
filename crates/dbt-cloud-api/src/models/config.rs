...
/// Config : The adapter-specific configuration for the connection
/// The adapter-specific configuration for the connection
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
#[serde(untagged)]
pub enum Config {
    SnowflakeConnection(Box<models::SnowflakeConnection>),
    PostgresConnection(Box<models::PostgresConnection>),
    RedshiftConnection(Box<models::RedshiftConnection>),
    BigqueryConnection(Box<models::BigqueryConnection>),
    BigqueryConnectionV1(Box<models::BigqueryConnectionV1>),
    DatabricksConnection(Box<models::DatabricksConnection>),
    //     DatabricksSparkConnection(Box<models::DatabricksSparkConnection>),
    //     TrinoConnection(Box<models::TrinoConnection>),
    //     FabricConnection(Box<models::FabricConnection>),
    //     SynapseConnection(Box<models::SynapseConnection>),
    //     ApacheSparkConnection(Box<models::ApacheSparkConnection>),
    //     AthenaConnection(Box<models::AthenaConnection>),
    //     TeradataConnection(Box<models::TeradataConnection>),
}

impl Default for Config {
    fn default() -> Self {
        Self::SnowflakeConnection(Default::default())
    }
}
