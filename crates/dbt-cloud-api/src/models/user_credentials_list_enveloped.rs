...
pub struct UserCredentialsListEnveloped {
    #[serde(rename = "data")]
    pub data: Vec<models::UserCredentialsResponse>,
    #[serde(rename = "extra")]
...
impl UserCredentialsListEnveloped {
    pub fn new(
        data: Vec<models::UserCredentialsResponse>,
        extra: models::Extra,
        status: models::ResponseStatus,
    ) -> UserCredentialsListEnveloped {
        UserCredentialsListEnveloped {
            data,
            extra: Box::new(extra),
